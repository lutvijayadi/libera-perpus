...
<body class="min-h-screen flex items-center pl-10 display-grid bg-no-repeat"
    style="background-image: url('../img/cover%20book.png'); background-position: center; background-size: cover;">

    <form action="../../aksi/aksi_login.php" method="post" class="bg-white p-8 rounded-xl shadow-xl/30 w-full max-w-sm">
        ...
        <p class="mt-4 text-center font-sans italic text-gray-600">belum punya akun? <a href="../view/registrasiuser.php" class="text-blue-500 hover:underline">Daftar</a></p>
    </form>
</body>
