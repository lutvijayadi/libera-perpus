...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2026 at 09:13 AM
...
(9, 'pwpb', 'majid', '0000', '100', '1771992327_pwpb.jfif', 'bapak anwar');
...
INSERT INTO `users` (`id_users`, `nama`, `username`, `password`, `level`, `status`) VALUES
(1, 'edi wel', 'lutvi', 'wel', 'siswa', 'aktif'),
(2, 'edi kurniawan', 'pi', 'we', 'admin', 'aktif'),
(4, '', 'majid', '123', 'siswa', 'aktif');
